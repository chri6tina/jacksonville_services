...
export const metadata = {
  ...
  keywords: 'Southside commercial cleaning Jacksonville, Southside office cleaning, JTB corridor cleaning, tech company cleaning Jacksonville FL, Southside business park cleaning',
  openGraph: {
    title: 'Southside Commercial Cleaning Services Jacksonville FL | Office Cleaning Southside',
    description: 'Modern commercial cleaning services in Southside Jacksonville FL. Specializing in tech companies, corporate offices, and modern business parks.',
    type: 'website',
    locale: 'en_US',
  },
  alternates: {
    canonical: 'https://jacksonvilleservices.com/services/commercial-cleaning/locations/southside'
  }
}

export default function SouthsideCommercialCleaning() {
  ...
  const services = [
    {
      ...
      description: 'Comprehensive cleaning for Southside corporate offices, law firms, and professional services',
      icon: FaBuilding,
    ...
    },
    {
      ...
      description: 'Specialized cleaning for Southside hospitals, clinics, and medical offices',
      icon: FaHospital,
    ...
    },
    {
      ...
      description: 'Professional cleaning for Southside retail stores, shopping centers, and commercial spaces',
      icon: FaBroom,
    ...
    },
    {
      ...
      description: 'Heavy-duty cleaning for Southside warehouses, manufacturing plants, and industrial spaces',
      icon: FaIndustry,
  ...
  const benefits = [
    'Customized cleaning contracts for Southside businesses',
    ...
    <div>
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img
            ...
            alt="Southside commercial cleaning services Jacksonville"
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-5xl mx-auto w-full">
          <h1 className="text-5xl md:text-7xl font-bold mb-8 leading-tight drop-shadow-2xl">
            Southside Commercial Cleaning
          </h1>
          <p className="text-xl md:text-2xl mb-12 text-neutral-200 max-w-4xl mx-auto leading-relaxed drop-shadow-lg">
            Professional commercial cleaning services for Southside businesses, corporations, and government facilities in Jacksonville, Florida. 
            Delivering enterprise-grade cleanliness and reliability in modern suburban communities.
          </p>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto mb-16">
            <div className="text-center">
              <div className="text-3xl font-bold text-white mb-2 drop-shadow-lg">90+</div>
              <div className="text-neutral-200 drop-shadow-md">Southside Businesses</div>
            </div>
            <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <Link
              href="/contact?service=commercial-cleaning&location=southside"
        ...
        <div className="container-custom">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-neutral-800 mb-4">
              Southside Commercial Cleaning Services
            </h2>
            <p className="text-xl text-neutral-600 max-w-3xl mx-auto">
              Serving Southside's thriving business community with professional commercial cleaning solutions. From the JTB Corridor 
              to the Gate Parkway area, we keep your commercial space pristine and professional.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-neutral-600 max-w-3xl mx-auto">
              We provide comprehensive commercial cleaning services throughout Southside's business districts and commercial areas.
            </p>
          </div>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-neutral-800 mb-4">
              Industries We Serve in Southside
            </h2>
            <p className="text-xl text-neutral-600 max-w-3xl mx-auto">
              Our commercial cleaning expertise spans across diverse industries in Southside, 
      ...
      <section className="section-padding bg-neutral-50">
        <div className="container-custom">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-neutral-800 mb-4">
              Why Choose Us for Southside Commercial Cleaning?
            </h2>
          </div>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-neutral-800 mb-2">Modern Business Expertise</h3>
                  <p className="text-neutral-600">We understand Southside's modern business landscape and work closely with local companies and facility managers.</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="w-6 h-6 bg-primary-600 rounded-full flex-shrink-0 mt-1"></div>
                <div>
                  ...
                  <p className="text-neutral-600">We work around Southside business schedules, including early morning, evening, and weekend services when needed.</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="w-6 h-6 bg-primary-600 rounded-full flex-shrink-0 mt-1"></div>
                <div>
                  ...
                  <p className="text-neutral-600">From routine maintenance to emergency cleanup, we handle all aspects of Southside commercial facility maintenance.</p>
                </div>
              </div>
            </div>
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-neutral-600">Fully licensed and insured for your peace of mind and protection in Southside commercial facilities.</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="w-6 h-6 bg-primary-600 rounded-full flex-shrink-0 mt-1"></div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-neutral-600">Transparent, competitive pricing with no hidden fees or surprise charges for Southside commercial services.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="section-padding bg-primary-700 text-white">
        <div className="container-custom text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Ready to Transform Your Southside Facility?
          </h2>
          <p className="text-xl mb-8 text-neutral-200 max-w-2xl mx-auto">
            Contact us today for a free consultation and customized quote for your Southside commercial cleaning needs.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            <Link href="/contact?service=commercial-cleaning&location=southside" className="bg-white text-primary-600 hover:bg-gray-100 font-semibold py-3 px-8 rounded-lg transition-colors duration-200 shadow-lg">
              Get Southside Quote
            </Link>
