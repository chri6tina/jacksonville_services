...
export const metadata = {
  ...
  keywords: 'Orange Park commercial cleaning Jacksonville, Orange Park office cleaning, Orange Park mall cleaning, suburban business cleaning Jacksonville FL, Orange Park shopping center cleaning',
  openGraph: {
    title: 'Orange Park Commercial Cleaning Services Jacksonville FL | Office Cleaning Orange Park',
    description: 'Suburban commercial cleaning services in Orange Park Jacksonville FL. Specializing in shopping centers, medical facilities, and suburban offices.',
    type: 'website',
    locale: 'en_US',
  },
  alternates: {
    canonical: 'https://jacksonvilleservices.com/services/commercial-cleaning/locations/orange-park'
  }
}

export default function OrangeParkCommercialCleaning() {
  const orangeParkAreas = [
    'Orange Park Mall',
    'Blanding Boulevard',
    'Wells Road',
    'Orange Park Town Center',
    'Orange Park Business District',
    'Kingsley Avenue',
    'Park Avenue',
    'Orange Park Station',
  ...
  const services = [
    {
      ...
      description: 'Comprehensive cleaning for Orange Park corporate offices, law firms, and professional services',
      icon: FaBuilding,
    ...
    },
    {
      ...
      description: 'Specialized cleaning for Orange Park hospitals, clinics, and medical offices',
      icon: FaHospital,
    ...
    },
    {
      ...
      description: 'Professional cleaning for Orange Park retail stores, shopping centers, and commercial spaces',
      icon: FaBroom,
    ...
    },
    {
      ...
      description: 'Heavy-duty cleaning for Orange Park warehouses, manufacturing plants, and industrial spaces',
      icon: FaIndustry,
  ...
  const benefits = [
    'Customized cleaning contracts for Orange Park businesses',
    ...
    <div>
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img
            ...
            alt="Orange Park commercial cleaning services Jacksonville"
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-5xl mx-auto w-full">
          <h1 className="text-5xl md:text-7xl font-bold mb-8 leading-tight drop-shadow-2xl">
            Orange Park Commercial Cleaning
          </h1>
          <p className="text-xl md:text-2xl mb-12 text-neutral-200 max-w-4xl mx-auto leading-relaxed drop-shadow-lg">
            Professional commercial cleaning services for Orange Park businesses, corporations, and government facilities in Jacksonville, Florida. 
            Delivering enterprise-grade cleanliness and reliability in suburban communities.
          </p>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto mb-16">
            <div className="text-center">
              <div className="text-3xl font-bold text-white mb-2 drop-shadow-lg">70+</div>
              <div className="text-neutral-200 drop-shadow-md">Orange Park Businesses</div>
            </div>
            <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <Link
              href="/contact?service=commercial-cleaning&location=orange-park"
        ...
        <div className="container-custom">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-neutral-800 mb-4">
              Orange Park Commercial Cleaning Services
            </h2>
            <p className="text-xl text-neutral-600 max-w-3xl mx-auto">
              Serving Orange Park's thriving business community with professional commercial cleaning solutions. From the Orange Park Mall 
              to the Blanding Boulevard corridor, we keep your commercial space pristine and professional.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-neutral-600 max-w-3xl mx-auto">
              We provide comprehensive commercial cleaning services throughout Orange Park's business districts and commercial areas.
            </p>
          </div>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-neutral-800 mb-4">
              Industries We Serve in Orange Park
            </h2>
            <p className="text-xl text-neutral-600 max-w-3xl mx-auto">
              Our commercial cleaning expertise spans across diverse industries in Orange Park, 
      ...
      <section className="section-padding bg-neutral-50">
        <div className="container-custom">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-neutral-800 mb-4">
              Why Choose Us for Orange Park Commercial Cleaning?
            </h2>
          </div>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-neutral-800 mb-2">Suburban Business Expertise</h3>
                  <p className="text-neutral-600">We understand Orange Park's suburban business landscape and work closely with local companies and facility managers.</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="w-6 h-6 bg-primary-600 rounded-full flex-shrink-0 mt-1"></div>
                <div>
                  ...
                  <p className="text-neutral-600">We work around Orange Park business schedules, including early morning, evening, and weekend services when needed.</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="w-6 h-6 bg-primary-600 rounded-full flex-shrink-0 mt-1"></div>
                <div>
                  ...
                  <p className="text-neutral-600">From routine maintenance to emergency cleanup, we handle all aspects of Orange Park commercial facility maintenance.</p>
                </div>
              </div>
            </div>
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-neutral-600">Fully licensed and insured for your peace of mind and protection in Orange Park commercial facilities.</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="w-6 h-6 bg-primary-600 rounded-full flex-shrink-0 mt-1"></div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-neutral-600">Transparent, competitive pricing with no hidden fees or surprise charges for Orange Park commercial services.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="section-padding bg-primary-700 text-white">
        <div className="container-custom text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Ready to Transform Your Orange Park Facility?
          </h2>
          <p className="text-xl mb-8 text-neutral-200 max-w-2xl mx-auto">
            Contact us today for a free consultation and customized quote for your Orange Park commercial cleaning needs.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            <Link href="/contact?service=commercial-cleaning&location=orange-park" className="bg-white text-primary-600 hover:bg-gray-100 font-semibold py-3 px-8 rounded-lg transition-colors duration-200 shadow-lg">
