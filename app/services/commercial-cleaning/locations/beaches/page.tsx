...
export const metadata = {
  ...
  keywords: 'Jacksonville Beaches commercial cleaning, Atlantic Beach cleaning, Neptune Beach cleaning, Ponte Vedra Beach cleaning, coastal business cleaning Jacksonville FL, beachfront office cleaning',
  openGraph: {
    title: 'Jacksonville Beaches Commercial Cleaning Services FL | Office Cleaning Beaches',
    description: 'Coastal commercial cleaning services in Jacksonville Beaches FL. Specializing in hospitality, tourism, and beachfront businesses.',
    type: 'website',
    locale: 'en_US',
  },
  alternates: {
    canonical: 'https://jacksonvilleservices.com/services/commercial-cleaning/locations/beaches'
  }
}

export default function BeachesCommercialCleaning() {
  const beachesAreas = [
    'Atlantic Beach',
    'Neptune Beach',
    'Ponte Vedra Beach',
    ...
    'Beach Boulevard',
    'JTB Corridor',
    'A1A Business District'
  ]

  const services = [
    {
      title: 'Office Building Cleaning',
      description: 'Comprehensive cleaning for Jacksonville Beaches corporate offices, law firms, and professional services',
      icon: FaBuilding,
    ...
    },
    {
      ...
      description: 'Professional cleaning for Jacksonville Beaches retail stores, shopping centers, and commercial spaces',
      icon: FaBroom,
      features: ['Sales floor cleaning', 'Fitting room maintenance', 'Display case cleaning', 'Customer area upkeep']
    },
    {
      title: 'Hospitality & Tourism Cleaning',
      description: 'Specialized cleaning for Jacksonville Beaches hotels, resorts, and tourism facilities',
      icon: FaIndustry,
      features: ['Guest room cleaning', 'Lobby maintenance', 'Pool area upkeep', 'Event space cleaning']
    },
    {
      title: 'Healthcare Facility Cleaning',
      description: 'Specialized cleaning for Jacksonville Beaches hospitals, clinics, and medical offices',
      icon: FaHospital,
  ...
  const benefits = [
    'Customized cleaning contracts for Jacksonville Beaches businesses',
    ...
    <div>
      ...
      <section className="bg-neutral-100 py-4">
        <div className="container-custom">
          <nav className="flex items-center space-x-2 text-sm text-neutral-600">
            ...
            <span>/</span>
            <span className="text-neutral-800 font-medium">Jacksonville Beaches</span>
          </nav>
        </div>
      </section>
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img
            ...
            alt="Jacksonville Beaches commercial cleaning services"
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-5xl mx-auto w-full">
          <h1 className="text-5xl md:text-7xl font-bold mb-8 leading-tight drop-shadow-2xl">
            Jacksonville Beaches Commercial Cleaning
          </h1>
          <p className="text-xl md:text-2xl mb-12 text-neutral-200 max-w-4xl mx-auto leading-relaxed drop-shadow-lg">
            Professional commercial cleaning services for Jacksonville Beaches businesses, resorts, and tourism facilities in Florida. 
            Delivering enterprise-grade cleanliness and reliability in coastal communities.
          </p>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto mb-16">
            <div className="text-center">
              <div className="text-3xl font-bold text-white mb-2 drop-shadow-lg">80+</div>
              <div className="text-neutral-200 drop-shadow-md">Beaches Businesses</div>
            </div>
            <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <Link
              href="/contact?service=commercial-cleaning&location=beaches"
        ...
        <div className="container-custom">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-neutral-800 mb-4">
              Jacksonville Beaches Commercial Cleaning Services
            </h2>
            <p className="text-xl text-neutral-600 max-w-3xl mx-auto">
              Serving Jacksonville Beaches' vibrant coastal business community with professional commercial cleaning solutions. From Atlantic Beach 
              to Ponte Vedra Beach, we keep your commercial space pristine and professional.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-neutral-600 max-w-3xl mx-auto">
              We provide comprehensive commercial cleaning services throughout Jacksonville Beaches' business districts and commercial areas.
            </p>
          </div>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-neutral-800 mb-4">
              Industries We Serve in Jacksonville Beaches
            </h2>
            <p className="text-xl text-neutral-600 max-w-3xl mx-auto">
              Our commercial cleaning expertise spans across diverse industries in Jacksonville Beaches, 
      ...
      <section className="section-padding bg-neutral-50">
        <div className="container-custom">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-neutral-800 mb-4">
              Why Choose Us for Jacksonville Beaches Commercial Cleaning?
            </h2>
          </div>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-neutral-800 mb-2">Coastal Business Expertise</h3>
                  <p className="text-neutral-600">We understand Jacksonville Beaches' unique coastal business environment and work closely with local businesses and facility managers.</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="w-6 h-6 bg-primary-600 rounded-full flex-shrink-0 mt-1"></div>
                <div>
                  ...
                  <p className="text-neutral-600">We work around Jacksonville Beaches business schedules, including early morning, evening, and weekend services when needed.</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="w-6 h-6 bg-primary-600 rounded-full flex-shrink-0 mt-1"></div>
                <div>
                  ...
                  <p className="text-neutral-600">From routine maintenance to emergency cleanup, we handle all aspects of Jacksonville Beaches commercial facility maintenance.</p>
                </div>
              </div>
            </div>
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-neutral-600">Fully licensed and insured for your peace of mind and protection in Jacksonville Beaches commercial facilities.</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="w-6 h-6 bg-primary-600 rounded-full flex-shrink-0 mt-1"></div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-neutral-600">Transparent, competitive pricing with no hidden fees or surprise charges for Jacksonville Beaches commercial services.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="section-padding bg-primary-700 text-white">
        <div className="container-custom text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Ready to Transform Your Jacksonville Beaches Facility?
          </h2>
          <p className="text-xl mb-8 text-neutral-200 max-w-2xl mx-auto">
            Contact us today for a free consultation and customized quote for your Jacksonville Beaches commercial cleaning needs.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            <Link href="/contact?service=commercial-cleaning&location=beaches" className="bg-white text-primary-600 hover:bg-gray-100 font-semibold py-3 px-8 rounded-lg transition-colors duration-200 shadow-lg">
              Get Beaches Quote
            </Link>
