...
export const metadata = {
  title: 'Mandarin Jacksonville Dog Poop Scooping Service | Pet Waste Removal Mandarin',
  description: 'Professional dog poop scooping service in Mandarin Jacksonville FL. Regular pet waste removal for homes, condos, and properties in Mandarin area.',
  keywords: 'Mandarin Jacksonville dog poop scooping, Mandarin pet waste removal, Mandarin dog waste cleanup, Mandarin poop service, Mandarin pet cleaning Jacksonville FL',
  openGraph: {
    title: 'Mandarin Jacksonville Dog Poop Scooping Service | Pet Waste Removal Mandarin',
    description: 'Professional dog poop scooping service in Mandarin Jacksonville FL. Regular pet waste removal for homes, condos, and properties.',
    type: 'website',
    locale: 'en_US',
  },
}
...
export default function MandarinPoopScooping() {
  const mandarinAreas = [
    'Mandarin Gardens',
    'Mandarin Lakes',
    'Mandarin Station',
  ...
  const services = [
    {
      ...
      description: 'Regular pet waste removal for Mandarin Jacksonville single-family homes and residential properties',
      iconName: 'home',
      features: ['Backyard cleanup', 'Front yard maintenance', 'Pool area cleaning', 'Garden bed service']
    },
    {
      title: 'Mandarin Condo Service',
      description: 'Professional pet waste removal for Mandarin condominiums and townhome communities',
      iconName: 'building',
      features: ['Condo common areas', 'Townhome communities', 'HOA partnerships', 'Shared space maintenance']
    },
    {
      title: 'Mandarin Park Service',
      description: 'Pet waste removal for Mandarin parks, trails, and community recreational areas',
      iconName: 'tree',
      features: ['Community parks', 'Walking trails', 'Dog park maintenance', 'Recreation area cleanup']
    },
    {
      title: 'Mandarin HOA Service',
      description: 'Specialized pet waste removal for Mandarin HOA communities and property management',
      iconName: 'dog',
    ...
    <div>
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img
            ...
            alt="Mandarin Jacksonville dog poop scooping services"
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-5xl mx-auto w-full">
          <h1 className="text-5xl md:text-7xl font-bold mb-8 leading-tight drop-shadow-2xl">
            Mandarin Jacksonville Dog Poop Scooping
          </h1>
          <p className="text-xl md:text-2xl mb-12 text-neutral-200 max-w-4xl mx-auto leading-relaxed drop-shadow-lg">
            Professional pet waste removal service for Mandarin Jacksonville homes, condos, and residential communities. 
            Keeping your Mandarin neighborhood clean and sanitary.
          </p>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto mb-16">
            <div className="text-center">
              <div className="text-3xl font-bold text-white mb-2 drop-shadow-lg">60+</div>
              <div className="text-neutral-200 drop-shadow-md">Mandarin Properties</div>
            </div>
            <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <Link
              href="/contact?service=poop-scooping&location=mandarin"
        ...
        <div className="container-custom">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-neutral-800 mb-4">
              Mandarin Jacksonville Pet Waste Removal Services
            </h2>
            <p className="text-xl text-neutral-600 max-w-3xl mx-auto">
              Serving Mandarin Jacksonville pet owners with specialized poop scooping services. From Mandarin Gardens to Mandarin Reserve, 
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-neutral-600 max-w-3xl mx-auto">
              We provide comprehensive pet waste removal services throughout Mandarin Jacksonville communities.
            </p>
          </div>
      ...
      <section className="section-padding bg-neutral-50">
        <div className="container-custom">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-neutral-800 mb-4">
              Mandarin Pet Waste Removal Services
            </h2>
          </div>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-neutral-800 mb-4">
              Why Choose Us for Mandarin Pet Waste Removal?
            </h2>
          </div>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-neutral-800 mb-2">Mandarin Community Expertise</h3>
                  <p className="text-neutral-600">We understand Mandarin Jacksonville's residential community needs and work closely with local HOA boards and property managers.</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="w-6 h-6 bg-primary-600 rounded-full flex-shrink-0 mt-1"></div>
                <div>
                  ...
                  <p className="text-neutral-600">We work around Mandarin schedules, including early morning and weekend services when needed.</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="w-6 h-6 bg-primary-600 rounded-full flex-shrink-0 mt-1"></div>
                <div>
                  ...
                  <p className="text-neutral-600">We use environmentally safe disposal methods that protect Mandarin's beautiful residential environment.</p>
                </div>
              </div>
            </div>
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-neutral-600">Fully licensed and insured for your peace of mind and protection in Mandarin properties.</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="w-6 h-6 bg-primary-600 rounded-full flex-shrink-0 mt-1"></div>
              ...
              <div className="flex items-start space-x-4">
                <div className="w-6 h-6 bg-primary-600 rounded-full flex-shrink-0 mt-1"></div>
                <div>
                  <h3 className="text-lg font-semibold text-neutral-800 mb-2">Competitive Mandarin Pricing</h3>
      ...
      <section className="section-padding bg-primary-700 text-white">
        <div className="container-custom text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Ready to Keep Your Mandarin Property Clean?
          </h2>
          <p className="text-xl mb-8 text-neutral-200 max-w-2xl mx-auto">
            Contact us today for a free consultation and customized quote for your Mandarin pet waste removal needs.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            <Link href="/contact?service=poop-scooping&location=mandarin" className="bg-white text-primary-600 hover:bg-gray-100 font-semibold py-3 px-8 rounded-lg transition-colors duration-200 shadow-lg">
              Get Mandarin Quote
            </Link>
