...
export const metadata = {
  title: 'Southside Jacksonville Dog Poop Scooping Service | Pet Waste Removal Southside',
  description: 'Professional dog poop scooping service in Southside Jacksonville FL. Regular pet waste removal for homes, condos, and properties in Southside area.',
  keywords: 'Southside Jacksonville dog poop scooping, Southside pet waste removal, Southside dog waste cleanup, Southside poop service, Southside pet cleaning Jacksonville FL',
  openGraph: {
    title: 'Southside Jacksonville Dog Poop Scooping Service | Pet Waste Removal Southside',
    description: 'Professional dog poop scooping service in Southside Jacksonville FL. Regular pet waste removal for homes, condos, and properties.',
    type: 'website',
    locale: 'en_US',
  },
}
...
export default function SouthsidePoopScooping() {
  ...
  const services = [
    {
      ...
      description: 'Regular pet waste removal for Southside Jacksonville single-family homes and residential properties',
      iconName: 'home',
      features: ['Backyard cleanup', 'Front yard maintenance', 'Pool area cleaning', 'Garden bed service']
    },
    {
      title: 'Southside Condo Service',
      description: 'Professional pet waste removal for Southside condominiums and townhome communities',
      iconName: 'building',
      features: ['Condo common areas', 'Townhome communities', 'HOA partnerships', 'Shared space maintenance']
    },
    {
      title: 'Southside Park Service',
      description: 'Pet waste removal for Southside parks, trails, and community recreational areas',
      iconName: 'tree',
      features: ['Community parks', 'Walking trails', 'Recreation areas', 'Public space maintenance']
    },
    {
      title: 'Business District Service',
      description: 'Specialized pet waste removal for Southside business parks and commercial properties',
      iconName: 'dog',
    ...
    <div>
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img
            ...
            alt="Southside Jacksonville dog poop scooping services"
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-5xl mx-auto w-full">
          <h1 className="text-5xl md:text-7xl font-bold mb-8 leading-tight drop-shadow-2xl">
            Southside Jacksonville Dog Poop Scooping
          </h1>
          <p className="text-xl md:text-2xl mb-12 text-neutral-200 max-w-4xl mx-auto leading-relaxed drop-shadow-lg">
            Professional pet waste removal service for Southside Jacksonville homes, condos, and residential communities. 
            Keeping your Southside neighborhood clean and sanitary.
          </p>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto mb-16">
            <div className="text-center">
              <div className="text-3xl font-bold text-white mb-2 drop-shadow-lg">65+</div>
              <div className="text-neutral-200 drop-shadow-md">Southside Properties</div>
            </div>
            <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <Link
              href="/contact?service=poop-scooping&location=southside"
        ...
        <div className="container-custom">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-neutral-800 mb-4">
              Southside Jacksonville Pet Waste Removal Services
            </h2>
            <p className="text-xl text-neutral-600 max-w-3xl mx-auto">
              Serving Southside Jacksonville pet owners with specialized poop scooping services. From Southside Boulevard to business parks, 
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-neutral-600 max-w-3xl mx-auto">
              We provide comprehensive pet waste removal services throughout Southside Jacksonville communities.
            </p>
          </div>
      ...
      <section className="section-padding bg-neutral-50">
        <div className="container-custom">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-neutral-800 mb-4">
              Southside Pet Waste Removal Services
            </h2>
          </div>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-neutral-800 mb-4">
              Why Choose Us for Southside Pet Waste Removal?
            </h2>
          </div>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-neutral-800 mb-2">Southside Community Expertise</h3>
                  <p className="text-neutral-600">We understand Southside Jacksonville's residential and business community needs and work closely with local HOA boards and property managers.</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="w-6 h-6 bg-primary-600 rounded-full flex-shrink-0 mt-1"></div>
                <div>
                  ...
                  <p className="text-neutral-600">Specialized service for Southside business parks and commercial properties with flexible scheduling.</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="w-6 h-6 bg-primary-600 rounded-full flex-shrink-0 mt-1"></div>
                <div>
                  ...
                  <p className="text-neutral-600">We use environmentally safe disposal methods that protect Southside's beautiful residential and business environment.</p>
                </div>
              </div>
            </div>
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-neutral-600">Fully licensed and insured for your peace of mind and protection in Southside properties.</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="w-6 h-6 bg-primary-600 rounded-full flex-shrink-0 mt-1"></div>
              ...
              <div className="flex items-start space-x-4">
                <div className="w-6 h-6 bg-primary-600 rounded-full flex-shrink-0 mt-1"></div>
                <div>
                  <h3 className="text-lg font-semibold text-neutral-800 mb-2">Competitive Southside Pricing</h3>
      ...
      <section className="section-padding bg-primary-700 text-white">
        <div className="container-custom text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Ready to Keep Your Southside Property Clean?
          </h2>
          <p className="text-xl mb-8 text-neutral-200 max-w-2xl mx-auto">
            Contact us today for a free consultation and customized quote for your Southside pet waste removal needs.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            <Link href="/contact?service=poop-scooping&location=southside" className="bg-white text-primary-600 hover:bg-gray-100 font-semibold py-3 px-8 rounded-lg transition-colors duration-200 shadow-lg">
              Get Southside Quote
            </Link>
